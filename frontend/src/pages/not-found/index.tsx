...
const ErrorPage: React.FC = () => {
  return (
    <div className="h-screen bg-black text-center text-gray-200 font-mono flex flex-col items-center justify-center">
      <div className="relative">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1123 837"
          fill="none"
          className="w-[clamp(300px,70%,600px)] h-[500px] animate-launch"
        >
          <rect width="1123" height="837" fill="black" />
          <g id="sky" className="animate-twinkle">
            <rect
              id="background"
              x="30"
              y="26"
      ...
      <div className="text opacity-0 animate-appear font-permanent-marker">
        <h1 className="text-4xl font-permanent-marker">404 Error</h1>
        <h2 className="text-2xl">Couldn't launch :(</h2>
        <h3 className="text-lg">
          Page Not Found - let's take you{" "}
          <Link
            to="/"
